/* $Id: b3pzld.c, v3.2 1998/6/16 18:00:00 Weidong Liu Release $  */
/*
 $Log:  b3pzld.c, v3.2 $
 ...
 *
*/
static char rcsid[] = "$Id: b3pzld.c, v3.2 1998/6/16 18:00:00 Weidong Liu Release $";
	 ...
	 {    if (here->BSIM3mode >= 0) 
	      ...
	      GBoverlapCap = here->pParam->BSIM3cgbo;
              ...
              *(here->BSIM3GspPtr) -= xgts;
              ...
              if (here->BSIM3nqsMod)
              {   *(here->BSIM3QqPtr ) += s->real;
                  *(here->BSIM3QqPtr +1) += s->imag;
