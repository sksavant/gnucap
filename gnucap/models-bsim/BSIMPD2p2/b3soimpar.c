/* $Id: b3soimpar.c,v 2.2 00/3/1 Pin Su Release $  */
/*
$Log:   b3soimpar.c,v $
 ...
 *
*/
static char rcsid[] = "$Id: b3soimpar.c,v 2.2 00/3/1 Pin Su Release $";
...
/* v2.2 release */
        ...
        case  B3SOI_MOD_EBG :
            ...
            break;
        case  B3SOI_MOD_NEVB :
            mod->B3SOInevb = value->rValue;
            mod->B3SOInevbGiven = TRUE;
            break;
        ...
        case  B3SOI_MOD_VGB1 :
            ...
            break;
        case  B3SOI_MOD_NECB :
            mod->B3SOInecb = value->rValue;
            mod->B3SOInecbGiven = TRUE;
            break;
        ...
        case  B3SOI_MOD_IGMOD :
            mod->B3SOIigMod = value->iValue;
            mod->B3SOIigModGiven = TRUE;
            break;
