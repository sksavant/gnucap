/* $Id: b3soiset.c,v 2.2 00/3/1 Pin Su Release $  */
/*
$Log:   b3soiset.c,v $
 ...
 *
*/
static char rcsid[] = "$Id: b3soiset.c,v 2.2 00/3/1 Pin Su Release $";
