...
FILE *fplog;
	...
	fprintf(fplog, "++++++++++ BSIM4 PARAMETER CHECKING BELOW ++++++++++\n");
        ...
        if (strcmp(model->BSIM4version, "4.6.2") != 0)
        {  fprintf(fplog, "Warning: This model is BSIM4.6.2; you specified a wrong version number.\n");
           printf("Warning: This model is BSIM4.6.2; you specified a wrong version number.\n");
        }
