/* $Id: b3soiacld.c,v 3.1 03/2/28 Pin Su Release $  */
/*
$Log:   b3soiacld.c,v $
 ...
 *
*/
static char rcsid[] = "$Id: b3soiacld.c,v 3.1 03/2/28 Pin Su Release $";
...
/* v3.1 wanh added variables for RF */
double T0;
double gcrgd, gcrgg, gcrgs, gcrgb, gcrg;
double xcgmgmb, xcgmdb, xcgmsb, xcgmeb, xcdgmb, xcsgmb, xcegmb, xcgbb;
double geltd;
double gcrgT;
...
/* v3.0 */
		...
		*(here->B3SOIGEgePtr) += geltd;
                ...
                *(here->B3SOIGgPtr) += geltd + gigg; /* v3.1 bug fix */
                *(here->B3SOIGdpPtr) += gigd; /* v3.1 bug fix */
                *(here->B3SOIGspPtr) += gigs; /* v3.1 bug fix */
		if (model->B3SOIsoiMod != 2)
                *(here->B3SOIGbPtr) -= -gigb; /* v3.1 bug fix */
              }
		...
		*(here->B3SOIGEgePtr) += gcrg;
		...
		if (model->B3SOIsoiMod != 2)
                ...
                *(here->B3SOIGgPtr) -= gcrgg - gigg; /* v3.1 bug fix */
                *(here->B3SOIGdpPtr) -= gcrgd - gigd; /* v3.1 bug fix */
                *(here->B3SOIGspPtr) -= gcrgs - gigs; /* v3.1 bug fix */
		if (model->B3SOIsoiMod != 2)
                *(here->B3SOIGbPtr) -= gcrgb - gigb; /* v3.1 bug fix */
              } 
		...
		*(here->B3SOIGEgePtr) += geltd;
		...
		if (model->B3SOIsoiMod != 2)
              ...
              {   
                *(here->B3SOIGgPtr)  += gigg; /* v3.1 bug fix */
                *(here->B3SOIGdpPtr) += gigd; /* v3.1 bug fix */
                *(here->B3SOIGspPtr) += gigs; /* v3.1 bug fix */
		if (model->B3SOIsoiMod != 2)
                *(here->B3SOIGbPtr)  += gigb; /* v3.1 bug fix */
