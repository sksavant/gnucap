...
static char rcsid[] = "$Id: b3check.c, v3.2.4 12/14/2001 18:00:00 Xuemei Xi Release $";
...
FILE *fplog;
    ...
    {   pParam = here->pParam;
	fprintf(fplog, "BSIM3v3.2.4 Parameter Checking.\n");
        if (strcmp(model->BSIM3version, "3.2.4"))
        {  fprintf(fplog, "Warning: This model is BSIM3v3.2.4; you specified a wrong version number.\n");
           printf("Warning: This model is BSIM3v3.2.4; you specified a wrong version number.\n"); 
        }
