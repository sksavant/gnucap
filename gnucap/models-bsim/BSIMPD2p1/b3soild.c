/* $Id: b3soild.c,v 2.1 99/9/27 Pin Su Release $  */
/*
$Log:   b3soild.c,v $
 ...
 *
*/
static char rcsid[] = "$Id: b3soild.c,v 2.1 99/9/27 Pin Su Release $";
...
#define MAX_EXPL 1.14200739e+26
#define MIN_EXPL 8.756510764e-27
#define EXPL_THRESHOLD 60.0
#define DEXP(A,B,C) {                                                         \
        if (A > EXPL_THRESHOLD) {                                              \
...
/*  calculate GIDL current  */
		  ...
		  {   Idgidl = Gdgidld = Gdgidlg = 0.0;
			...
			Gdgidlg = T3 * dT1_dVg;
		     ...
		     {
			T3 = wdiod * pParam->B3SOIagidl * MIN_EXP;
			Idgidl = T3 * T1 ;
			Gdgidld  = T3 * dT1_dVd;
			Gdgidlg  = T3 * dT1_dVg;
		     } 
		  ...
		  else
		  {
			...
			Gsgidlg = T3 * dT1_dVg;
		     ...
		     {
			T3 = wdios * pParam->B3SOIagidl * MIN_EXP;
			Isgidl = T3 * T1 ;
			Gsgidlg = T3 * dT1_dVg;
		     } 
		  }
