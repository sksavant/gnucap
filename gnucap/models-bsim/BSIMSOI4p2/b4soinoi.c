...
static char rcsid[] = "$Id: b4soinoi.c  09/22/2009 Released by Tanvir Morshed $";
...
double
B4SOIEval1ovFNoise(vds, model, here, freq, temp)
...
int
B4SOInoise (mode, operation, inModel, ckt, data, OnDens)
int mode, operation;
GENmodel *inModel;
CKTcircuit *ckt;
register Ndata *data;
