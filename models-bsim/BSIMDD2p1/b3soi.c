 ...
 *
*/
static char rcsid[] = "$Id: b3soi.c, DD2.1 99/9/27 Pin Su Release $";
...
IOP( "kb1", B3SOI_MOD_KB1, IF_REAL, "Backgate coupling coefficient at strong inversion"),   
IOP( "kb3", B3SOI_MOD_KB3, IF_REAL, "Backgate coupling coefficient at subthreshold"),   
IOP( "dvbd0", B3SOI_MOD_DVBD0, IF_REAL, "First coefficient of short-channel effect on Vbs0t"),   
IOP( "dvbd1", B3SOI_MOD_DVBD1, IF_REAL, "Second coefficient of short-channel effect on Vbs0t"),   
IOP( "vbsa", B3SOI_MOD_VBSA, IF_REAL, "Vbs0t offset voltage"),
IOP( "delp", B3SOI_MOD_DELP, IF_REAL, "Offset constant for limiting Vbseff to Phis"),
...
IOP( "adice0", B3SOI_MOD_ADICE0, IF_REAL, "DICE constant for bulk charge effect"),   
IOP( "abp", B3SOI_MOD_ABP, IF_REAL, "Gate bias coefficient for Xcsat calculation"),   
IOP( "mxc", B3SOI_MOD_MXC, IF_REAL, "A smoothing parameter for Xcsat calculation"),   
...
IOP( "aii", B3SOI_MOD_AII, IF_REAL, "1st Vdsatii parameter"),   
IOP( "bii", B3SOI_MOD_BII, IF_REAL, "2nd Vdsatii parameter"),   
IOP( "cii", B3SOI_MOD_CII, IF_REAL, "3rd Vdsatii parameter"),   
IOP( "dii", B3SOI_MOD_DII, IF_REAL, "4th Vdsatii parameter"),   
...
IOP( "edl", B3SOI_MOD_EDL, IF_REAL, "Electron diffusion length"),   
IOP( "kbjt1", B3SOI_MOD_KBJT1, IF_REAL, "Vds dependency on BJT base width"),   
...
IOP( "alpha1", B3SOI_MOD_ALPHA1, IF_REAL, "substrate current model parameter"),
IOP( "beta0", B3SOI_MOD_BETA0, IF_REAL, "substrate current model parameter"),
...
IOP( "lvbsa",  B3SOI_MOD_LVBSA, IF_REAL, "Length dependence of vbsa"),
IOP( "ldelp",  B3SOI_MOD_LDELP, IF_REAL, "Length dependence of delp"),
IOP( "lkb1",  B3SOI_MOD_LKB1, IF_REAL, "Length dependence of kb1"),
IOP( "lkb3",  B3SOI_MOD_LKB3, IF_REAL, "Length dependence of kb3"),
IOP( "ldvbd0",  B3SOI_MOD_LDVBD0, IF_REAL, "Length dependence of dvbd0"),
IOP( "ldvbd1",  B3SOI_MOD_LDVBD1, IF_REAL, "Length dependence of dvbd1"),
...
IOP( "labp", B3SOI_MOD_LABP, IF_REAL, "Length dependence of abp"),
IOP( "lmxc", B3SOI_MOD_LMXC, IF_REAL, "Length dependence of mxc"),
IOP( "ladice0", B3SOI_MOD_LADICE0, IF_REAL, "Length dependence of adice0"),
...
IOP( "laii", B3SOI_MOD_LAII, IF_REAL, "Length dependence of aii"),
IOP( "lbii", B3SOI_MOD_LBII, IF_REAL, "Length dependence of bii"),
IOP( "lcii", B3SOI_MOD_LCII, IF_REAL, "Length dependence of cii"),
IOP( "ldii", B3SOI_MOD_LDII, IF_REAL, "Length dependence of dii"),
IOP( "lalpha0", B3SOI_MOD_LALPHA0, IF_REAL, "Length dependence of alpha0"),
IOP( "lalpha1", B3SOI_MOD_LALPHA1, IF_REAL, "Length dependence of alpha1"),
...
IOP( "ledl", B3SOI_MOD_LEDL, IF_REAL, "Length dependence of edl"),
IOP( "lkbjt1", B3SOI_MOD_LKBJT1, IF_REAL, "Length dependence of kbjt1"),
...
IOP( "wvbsa",  B3SOI_MOD_WVBSA, IF_REAL, "Width dependence of vbsa"),
IOP( "wdelp",  B3SOI_MOD_WDELP, IF_REAL, "Width dependence of delp"),
IOP( "wkb1",  B3SOI_MOD_WKB1, IF_REAL, "Width dependence of kb1"),
IOP( "wkb3",  B3SOI_MOD_WKB3, IF_REAL, "Width dependence of kb3"),
IOP( "wdvbd0",  B3SOI_MOD_WDVBD0, IF_REAL, "Width dependence of dvbd0"),
IOP( "wdvbd1",  B3SOI_MOD_WDVBD1, IF_REAL, "Width dependence of dvbd1"),
...
IOP( "wabp", B3SOI_MOD_WABP, IF_REAL, "Width dependence of abp"),
IOP( "wmxc", B3SOI_MOD_WMXC, IF_REAL, "Width dependence of mxc"),
IOP( "wadice0", B3SOI_MOD_WADICE0, IF_REAL, "Width dependence of adice0"),
...
IOP( "waii", B3SOI_MOD_WAII, IF_REAL, "Width dependence of aii"),
IOP( "wbii", B3SOI_MOD_WBII, IF_REAL, "Width dependence of bii"),
IOP( "wcii", B3SOI_MOD_WCII, IF_REAL, "Width dependence of cii"),
IOP( "wdii", B3SOI_MOD_WDII, IF_REAL, "Width dependence of dii"),
IOP( "walpha0", B3SOI_MOD_WALPHA0, IF_REAL, "Width dependence of alpha0"),
IOP( "walpha1", B3SOI_MOD_WALPHA1, IF_REAL, "Width dependence of alpha1"),
...
IOP( "wedl", B3SOI_MOD_WEDL, IF_REAL, "Width dependence of edl"),
IOP( "wkbjt1", B3SOI_MOD_WKBJT1, IF_REAL, "Width dependence of kbjt1"),
...
IOP( "pvbsa",  B3SOI_MOD_PVBSA, IF_REAL, "Cross-term dependence of vbsa"),
IOP( "pdelp",  B3SOI_MOD_PDELP, IF_REAL, "Cross-term dependence of delp"),
IOP( "pkb1",  B3SOI_MOD_PKB1, IF_REAL, "Cross-term dependence of kb1"),
IOP( "pkb3",  B3SOI_MOD_PKB3, IF_REAL, "Cross-term dependence of kb3"),
IOP( "pdvbd0",  B3SOI_MOD_PDVBD0, IF_REAL, "Cross-term dependence of dvbd0"),
IOP( "pdvbd1",  B3SOI_MOD_PDVBD1, IF_REAL, "Cross-term dependence of dvbd1"),
...
IOP( "pabp", B3SOI_MOD_PABP, IF_REAL, "Cross-term dependence of abp"),
IOP( "pmxc", B3SOI_MOD_PMXC, IF_REAL, "Cross-term dependence of mxc"),
IOP( "padice0", B3SOI_MOD_PADICE0, IF_REAL, "Cross-term dependence of adice0"),
...
IOP( "paii", B3SOI_MOD_PAII, IF_REAL, "Cross-term dependence of aii"),
IOP( "pbii", B3SOI_MOD_PBII, IF_REAL, "Cross-term dependence of bii"),
IOP( "pcii", B3SOI_MOD_PCII, IF_REAL, "Cross-term dependence of cii"),
IOP( "pdii", B3SOI_MOD_PDII, IF_REAL, "Cross-term dependence of dii"),
IOP( "palpha0", B3SOI_MOD_PALPHA0, IF_REAL, "Cross-term dependence of alpha0"),
IOP( "palpha1", B3SOI_MOD_PALPHA1, IF_REAL, "Cross-term dependence of alpha1"),
...
IOP( "pedl", B3SOI_MOD_PEDL, IF_REAL, "Cross-term dependence of edl"),
IOP( "pkbjt1", B3SOI_MOD_PKBJT1, IF_REAL, "Cross-term dependence of kbjt1"),
