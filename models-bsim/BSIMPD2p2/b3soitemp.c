/* $Id: b3soitemp.c,v 2.2 00/3/1 Pin Su Release $  */
/*
$Log:   b3soitemp.c,v $
 ...
 *
*/
static char rcsid[] = "$Id: b3soitemp.c,v 2.2 00/3/1 Pin Su Release $";
...
/* v2.2 release */
                  ...
                  pParam->B3SOIcth = here->B3SOIcth0 * (pParam->B3SOIweff + model->B3SOIwth0)
                                   / here->B3SOInseg;
                  pParam->B3SOIrbody = model->B3SOIrbody * model->B3SOIrhalo
