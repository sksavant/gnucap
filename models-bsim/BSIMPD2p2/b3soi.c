/* $Id: b3soi.c,v 2.2 00/3/1 Pin Su Release $  */
/*
$Log:   b3soi.c,v $
 ...
 *
*/
static char rcsid[] = "$Id: b3soi.c,v 2.2 00/3/1 Pin Su Release $";
...
/* v2.2 release */
IOP( "igmod", B3SOI_MOD_IGMOD, IF_INTEGER, "gate current model selector"),
...
IOP( "nevb", B3SOI_MOD_NEVB, IF_REAL, "valence-band electron non-ideality factor"),
...
IOP( "necb", B3SOI_MOD_NECB, IF_REAL, "conduction-band electron non-ideality factor"),
