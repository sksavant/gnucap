...
static char rcsid[] = "$Id: b3check.c, v3.2.3 10/05/2001 18:00:00 Xuemei Xi Release $";
...
FILE *fplog;
    ...
    {   pParam = here->pParam;
	fprintf(fplog, "BSIM3v3.2.3 Parameter Checking.\n");
        if (strcmp(model->BSIM3version, "3.2.3"))
        {  fprintf(fplog, "Warning: This model is BSIM3v3.2.3; you specified a wrong version number.\n");
           printf("Warning: This model is BSIM3v3.2.3; you specified a wrong version number.\n"); 
        }
