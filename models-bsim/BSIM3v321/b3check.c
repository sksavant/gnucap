/* $Id: b3check.c, v3.2.1 1999/4/20 18:00:00 Weidong Liu Release $  */
/*
 $Log:  b3check.c, v3.2.1 $
 * Revision 3.2.1 1999/4/20  18:00:00  Weidong
 * BSIM3v3.2.1 release
 *
*/
static char rcsid[] = "$Id: b3check.c, v3.2.1 1999/4/20 18:00:00 Weidong Liu Release $";
...
FILE *fplog;
    ...
    {   pParam = here->pParam;
	fprintf(fplog, "BSIM3v3.2.1 Parameter Checking.\n");
        if (strcmp(model->BSIM3version, "3.2.1"))
        {  fprintf(fplog, "Warning: This model is BSIM3v3.2.1; you specified a wrong version number.\n");
           printf("Warning: This model is BSIM3v3.2.1; you specified a wrong version number.\n"); 
        }
