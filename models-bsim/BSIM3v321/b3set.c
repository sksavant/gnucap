/* $Id: b3set.c, v3.2.1 1999/4/20 18:00:00 Weidong Liu Release $  */
/*
 $Log:  b3set.c, v3.2.1 $
 ...
 *
*/
static char rcsid[] = "$Id: b3set.c, v3.2.1 1999/4/20 18:00:00 Weidong Liu Release $";
