/* $Id: b3check.c, v3.2 1998/6/16 18:00:00 Weidong Liu Release $  */
/*
 $Log:  b3check.c, v3.2 $
 ...
 *
*/
static char rcsid[] = "$Id: b3check.c, v3.2 1998/6/16 18:00:00 Weidong Liu Release $";
...
FILE *fplog;
    ...
    {   pParam = here->pParam;
	fprintf(fplog, "BSIM3V3 Parameter Check\n");
	fprintf(fplog, "Model = %s\n", model->BSIM3modName);
	fprintf(fplog, "W = %g, L = %g\n", here->BSIM3w, here->BSIM3l);
