/* $Id: b3soiacld.c,v 2.0 99/2/15 Pin Su Release $  */
/*
$Log:   b3soiacld.c,v $
 ...
 *
*/
static char rcsid[] = "$Id: b3soiacld.c,v 2.0 99/2/15 Pin Su Release $";
	 ...
	 {    
	      ...
	      GEoverlapCap = model->B3SOIcgeo;
		    ...
		    * omega;
              ...
              xcssb = (GSoverlapCap - (cgsb + cbsb + cdsb)) * omega;
              xcseb = -(cbeb + cdeb + ceeb) * omega;
