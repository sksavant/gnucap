/* $Id: b3soi.c,v 3.2 02/24/04 Hui Wan Release $  */
/*
$Log:   b3soi.c,v $
 ...
 *
*/
static char rcsid[] = "$Id: b3soi.c,v 3.2 02/24/04 Hui Wan Release $";
...
IOP( "soimod", B3SOI_SOIMOD, IF_INTEGER,    "Instance model selector for PD/FD operation"), /* v3.2 */
...
/*v3.1 wanh added rgatemod */
IOP( "rgatemod", B3SOI_RGATEMOD, IF_INTEGER, "Gate resistance model selector"),
/*v3.1 wanh added rgatemod */
...
/*IOP( "noimod", B3SOI_MOD_NOIMOD, IF_INTEGER, "Noise model selector"), v3.2 */
...
IOP( "toxm", B3SOI_MOD_TOXM, IF_REAL, "Gate oxide thickness used in extraction"), /* v3.2 */
...
/* v3.2 */
IOP( "fnoimod", B3SOI_MOD_FNOIMOD, IF_INTEGER, "Flicker noise model selector"),
IOP( "tnoimod", B3SOI_MOD_TNOIMOD, IF_INTEGER, "Thermal noise model selector"),
IOP( "tnoia", B3SOI_MOD_TNOIA, IF_REAL, "Thermal noise parameter"),
IOP( "tnoib", B3SOI_MOD_TNOIB, IF_REAL, "Thermal noise parameter"),
IOP( "rnoia", B3SOI_MOD_RNOIA, IF_REAL, "Thermal noise coefficient"),
IOP( "rnoib", B3SOI_MOD_RNOIB, IF_REAL, "Thermal noise coefficient"),
IOP( "ntnoi", B3SOI_MOD_NTNOI, IF_REAL, "Thermal noise parameter"),
/* v3.2 */
...
IOP( "noff", B3SOI_MOD_NOFF, IF_REAL, "C-V turn-on/off parameter"), /* v3.2 */
...
/* v2.2 release */
IOP( "igmod",  B3SOI_MOD_IGBMOD, IF_INTEGER, "gate-body tunneling current model selector"), /* v3.1.1 */
...
/* v3.0 */
IOP( "soimod", B3SOI_MOD_SOIMOD, IF_INTEGER, "model selector for SOI technology"), /* v3.2 bug fix */
IOP( "vbs0pd", B3SOI_MOD_VBS0PD, IF_REAL, "Upper bound of built-in potential lowering for PD operation"), /* v3.2 */
IOP( "vbs0fd", B3SOI_MOD_VBS0FD, IF_REAL, "Lower bound of built-in potential lowering for FD operation"), /* v3.2 */
...
IOP( "rgatemod", B3SOI_MOD_RGATEMOD, IF_INTEGER, "Gate R model selector"),
IOP("xrcrg1", B3SOI_MOD_XRCRG1, IF_REAL, "First fitting parameter the bias-dependent Rg"),
IOP("xrcrg2", B3SOI_MOD_XRCRG2, IF_REAL, "Second fitting parameter the bias-dependent Rg"),
IOP("rshg", B3SOI_MOD_RSHG, IF_REAL, "Gate sheet resistance"),
IOP("ngcon", B3SOI_MOD_NGCON, IF_REAL, "Number of gate contacts"),
IOP( "xgw",  B3SOI_MOD_XGW, IF_REAL, "Distance from gate contact center to device edge"),
IOP( "xgl",  B3SOI_MOD_XGL, IF_REAL, "Variation in Ldrawn"),
...
/* Length Dependence */
/* v3.1 */
IOP( "lxj", B3SOI_MOD_LXJ, IF_REAL, "Length dependence of xj"),
IOP( "lalphagb1", B3SOI_MOD_LALPHAGB1, IF_REAL, "Length dependence of alphagb1"),
IOP( "lbetagb1", B3SOI_MOD_LBETAGB1, IF_REAL, "Length dependence of betagb1"),
IOP( "lalphagb2", B3SOI_MOD_LALPHAGB2, IF_REAL, "Length dependence of alphagb2"),
IOP( "lbetagb2", B3SOI_MOD_LBETAGB2, IF_REAL, "Length dependence of betagb2"),
IOP( "lcgsl", B3SOI_MOD_LCGSL, IF_REAL, "Length dependence of cgsl"),
IOP( "lcgdl", B3SOI_MOD_LCGDL, IF_REAL, "Length dependence of cgdl"),
IOP( "lckappa", B3SOI_MOD_LCKAPPA, IF_REAL, "Length dependence of ckappa"),
IOP( "lndif", B3SOI_MOD_LNDIF, IF_REAL, "Length dependence of ndif"),
IOP( "lute", B3SOI_MOD_LUTE, IF_REAL, "Length dependence of ute"),
IOP( "lkt1", B3SOI_MOD_LKT1, IF_REAL, "Length dependence of kt1"),
IOP( "lkt1l", B3SOI_MOD_LKT1L, IF_REAL, "Length dependence of kt1l"),
IOP( "lkt2",  B3SOI_MOD_LKT2, IF_REAL, "Length dependence of kt2"),
IOP( "lua1", B3SOI_MOD_LUA1, IF_REAL, "Length dependence of ua1"),
IOP( "lub1", B3SOI_MOD_LUB1, IF_REAL, "Length dependence of ub1"),
IOP( "luc1", B3SOI_MOD_LUC1, IF_REAL, "Length dependence of uc1"),
IOP( "lat", B3SOI_MOD_LAT, IF_REAL, "Length dependence of at"),
IOP( "lprt", B3SOI_MOD_LPRT, IF_REAL, "Length dependence of prt "),
IOP( "lntrecf", B3SOI_MOD_LNTRECF, IF_REAL, "Length dependence of ntrecf"),
IOP( "lntrecr", B3SOI_MOD_LNTRECR, IF_REAL, "Length dependence of ntrecr"),
IOP( "lxbjt", B3SOI_MOD_LXBJT, IF_REAL, "Length dependence of xbjt"),
IOP( "lxdif", B3SOI_MOD_LXDIF, IF_REAL, "Length dependence of xdif"),
IOP( "lxrec", B3SOI_MOD_LXREC, IF_REAL, "Length dependence of xrec"),
IOP( "lxtun", B3SOI_MOD_LXTUN, IF_REAL, "Length dependence of xtun"),
...
IOP( "lnoff", B3SOI_MOD_LNOFF, IF_REAL, "Length dependence of noff"), /* v3.2 */

/* v3.1 wanh added for RF */
IOP("lxrcrg1", B3SOI_MOD_LXRCRG1, IF_REAL, "Length dependence of xrcrg1"),
IOP("lxrcrg2", B3SOI_MOD_LXRCRG2, IF_REAL, "Length dependence of xrcrg2"),
/* v3.1 wanh added for RF end*/

/* Width Dependence */
/* v3.1 */
IOP( "wxj", B3SOI_MOD_WXJ, IF_REAL, "Width dependence of xj"),
IOP( "walphagb1", B3SOI_MOD_WALPHAGB1, IF_REAL, "Width dependence of alphagb1"),
IOP( "wbetagb1", B3SOI_MOD_WBETAGB1, IF_REAL, "Width dependence of betagb1"),
IOP( "walphagb2", B3SOI_MOD_WALPHAGB2, IF_REAL, "Width dependence of alphagb2"),
IOP( "wbetagb2", B3SOI_MOD_WBETAGB2, IF_REAL, "Width dependence of betagb2"),
IOP( "wcgsl", B3SOI_MOD_WCGSL, IF_REAL, "Width dependence of cgsl"),
IOP( "wcgdl", B3SOI_MOD_WCGDL, IF_REAL, "Width dependence of cgdl"),
IOP( "wckappa", B3SOI_MOD_WCKAPPA, IF_REAL, "Width dependence of ckappa"),
IOP( "wndif", B3SOI_MOD_WNDIF, IF_REAL, "Width dependence of ndif"),
IOP( "wute", B3SOI_MOD_WUTE, IF_REAL, "Width dependence of ute"),
IOP( "wkt1", B3SOI_MOD_WKT1, IF_REAL, "Width dependence of kt1"),
IOP( "wkt1l", B3SOI_MOD_WKT1L, IF_REAL, "Width dependence of kt1l"),
IOP( "wkt2",  B3SOI_MOD_WKT2, IF_REAL, "Width dependence of kt2"),
IOP( "wua1", B3SOI_MOD_WUA1, IF_REAL, "Width dependence of ua1"),
IOP( "wub1", B3SOI_MOD_WUB1, IF_REAL, "Width dependence of ub1"),
IOP( "wuc1", B3SOI_MOD_WUC1, IF_REAL, "Width dependence of uc1"),
IOP( "wat", B3SOI_MOD_WAT, IF_REAL, "Width dependence of at"),
IOP( "wprt", B3SOI_MOD_WPRT, IF_REAL, "Width dependence of prt "),
IOP( "wntrecf", B3SOI_MOD_WNTRECF, IF_REAL, "Width dependence of ntrecf"),
IOP( "wntrecr", B3SOI_MOD_WNTRECR, IF_REAL, "Width dependence of ntrecr"),
IOP( "wxbjt", B3SOI_MOD_WXBJT, IF_REAL, "Width dependence of xbjt"),
IOP( "wxdif", B3SOI_MOD_WXDIF, IF_REAL, "Width dependence of xdif"),
IOP( "wxrec", B3SOI_MOD_WXREC, IF_REAL, "Width dependence of xrec"),
IOP( "wxtun", B3SOI_MOD_WXTUN, IF_REAL, "Width dependence of xtun"),
...
IOP( "wnoff", B3SOI_MOD_WNOFF, IF_REAL, "Width dependence of noff"), /* v3.2 */

/* v3.1 added for RF */
IOP("wxrcrg1", B3SOI_MOD_WXRCRG1, IF_REAL, "Width dependence of xrcrg1"),
IOP("Wxrcrg2", B3SOI_MOD_WXRCRG2, IF_REAL, "Width dependence of xrcrg2"),
/* added for RF model end*/


/* Cross-term Dependence */
/* v3.1 */
IOP( "pxj", B3SOI_MOD_PXJ, IF_REAL, "Cross-term dependence of xj"),
IOP( "palphagb1", B3SOI_MOD_PALPHAGB1, IF_REAL, "Cross-term dependence of alphagb1"),
IOP( "pbetagb1", B3SOI_MOD_PBETAGB1, IF_REAL, "Cross-term dependence of betagb1"),
IOP( "palphagb2", B3SOI_MOD_PALPHAGB2, IF_REAL, "Cross-term dependence of alphagb2"),
IOP( "pbetagb2", B3SOI_MOD_PBETAGB2, IF_REAL, "Cross-term dependence of betagb2"),
IOP( "pcgsl", B3SOI_MOD_PCGSL, IF_REAL, "Cross-term dependence of cgsl"),
IOP( "pcgdl", B3SOI_MOD_PCGDL, IF_REAL, "Cross-term dependence of cgdl"),
IOP( "pckappa", B3SOI_MOD_PCKAPPA, IF_REAL, "Cross-term dependence of ckappa"),
IOP( "pndif", B3SOI_MOD_PNDIF, IF_REAL, "Cross-term dependence of ndif"),
IOP( "pute", B3SOI_MOD_PUTE, IF_REAL, "Cross-term dependence of ute"),
IOP( "pkt1", B3SOI_MOD_PKT1, IF_REAL, "Cross-term dependence of kt1"),
IOP( "pkt1l", B3SOI_MOD_PKT1L, IF_REAL, "Cross-term dependence of kt1l"),
IOP( "pkt2",  B3SOI_MOD_PKT2, IF_REAL, "Cross-term dependence of kt2"),
IOP( "pua1", B3SOI_MOD_PUA1, IF_REAL, "Cross-term dependence of ua1"),
IOP( "pub1", B3SOI_MOD_PUB1, IF_REAL, "Cross-term dependence of ub1"),
IOP( "puc1", B3SOI_MOD_PUC1, IF_REAL, "Cross-term dependence of uc1"),
IOP( "pat", B3SOI_MOD_PAT, IF_REAL, "Cross-term dependence of at"),
IOP( "pprt", B3SOI_MOD_PPRT, IF_REAL, "Cross-term dependence of prt "),
IOP( "pntrecf", B3SOI_MOD_PNTRECF, IF_REAL, "Cross-term dependence of ntrecf"),
IOP( "pntrecr", B3SOI_MOD_PNTRECR, IF_REAL, "Cross-term dependence of ntrecr"),
IOP( "pxbjt", B3SOI_MOD_PXBJT, IF_REAL, "Cross-term dependence of xbjt"),
IOP( "pxdif", B3SOI_MOD_PXDIF, IF_REAL, "Cross-term dependence of xdif"),
IOP( "pxrec", B3SOI_MOD_PXREC, IF_REAL, "Cross-term dependence of xrec"),
IOP( "pxtun", B3SOI_MOD_PXTUN, IF_REAL, "Cross-term dependence of xtun"),
...
IOP( "pnoff", B3SOI_MOD_PNOFF, IF_REAL, "Cross-term dependence of noff"), /* v3.2 */

/* v3.1 wanh added for RF */
IOP("pxrcrg1", B3SOI_MOD_PXRCRG1, IF_REAL, "Cross-term dependence of xrcrg1"),
IOP("pxrcrg2", B3SOI_MOD_PXRCRG2, IF_REAL, "Cross-term dependence of xrcrg2"),
/* v3.1 wanh added for RF end */
