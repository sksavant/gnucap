/* $Id: b3soild.c,v 3.2 02/24/04 Hui Wan Release $  */
/*
$Log:   b3soild.c,v $
 ...
 *
*/
static char rcsid[] = "$Id: b3soild.c,v 3.2 02/24/04 Hui Wan Release $";
...
/* v3.1 */
                   if (here->B3SOIsoiMod != 2) /* v3.2 */
                   {
                      (*(here->B3SOIEbPtr) -= gcegb + gcedb + gcesb + gceeb + gcegmb); /* 3.2 bug fix */
