/* $Id: b3check.c, v3.2.2 1999/4/20 18:00:00 Weidong Liu Release $  */
/*
 $Log:  b3check.c, v3.2.2 $
 * Revision 3.2.2 1999/4/20  18:00:00  Weidong
 * BSIM3v3.2.2 release
 *
*/
static char rcsid[] = "$Id: b3check.c, v3.2.2 1999/4/20 18:00:00 Weidong Liu Release $";
