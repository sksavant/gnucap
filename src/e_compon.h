/*$Id: e_compon.h,v 1.21 2010-08-26 09:07:18 felix Exp $ -*- C++ -*-
 * vim:ts=8:sw=2:et:
...
public:
  ...
  virtual void	stress_apply() {untested0("COMP::stress_apply()");}
...
public:	// ports
  ...
  virtual uint_t	net_nodes()const	{untested();return 0;} //override
