...
#ifndef D_MOS.ORIG_H_INCLUDED
#define D_MOS.ORIG_H_INCLUDED
...
private: // override virtual
  ...
  int       max_nodes()const     {return 5;}
  int       min_nodes()const     {return 5;}
  //int     matrix_nodes()const; //BASE_SUBCKT
  int       net_nodes()const     {return 5;}
...
public: // netlist
  ...
  COMPONENT* _Isb;
private: // node list
  enum {n_d, n_g, n_s, n_b, n_u_eff, n_id, n_is};
  node_t _nodes[7];
  std::string port_name(int i)const {
    assert(i >= 0);
    assert(i < 5);
    static std::string names[] = {"d", "g", "s", "b", "u_eff", ""};
    return names[i];
  }
};
/*--------------------------------------------------------------------------*/
