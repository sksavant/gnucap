...
/*--------------------------------------------------------------------------*/
inline void ADMS_BASE::tr_load_inode()
{
...
/*--------------------------------------------------------------------------*/
inline void ADMS_BASE::tr_unload_inode()
{untested();
  _loss0 = 0.;
...
/*--------------------------------------------------------------------------*/
inline void ADMS_BASE::tr_unload_shunt()
{untested();
  _loss0 = 0.;
  _sim->mark_inc_mode_bad();
  tr_load_shunt();
...
/*--------------------------------------------------------------------------*/
inline void ADMS_BASE::ac_load_shunt()
{
  _sim->_acx.load_symmetric(_n[OUT1].m_(), _n[OUT2].m_(), mfactor() * _loss0);
}
/*--------------------------------------------------------------------------*/
inline void ADMS_BASE::tr_load_source()
{
#if !defined(NDEBUG)
  trace2(("ADMS_BASE::tr_load_source " + long_label()).c_str(), _loaditer,
      _sim->iteration_tag() );

  if (_loaditer == _sim->iteration_tag()){
    // this is a HACK
    error(bDANGER, "ADMS_BASE::tr_load_source. double load %s %i\n", long_label().c_str(), _loaditer);
    return;
  }
  ...
  trace1("ADMS_BASE::tr_load_source ", d);
  if (d != 0.) {
...
/*--------------------------------------------------------------------------*/
inline void ADMS_BASE::tr_unload_source()
{untested();
  _m0.c0 = _m0.c1 = 0.;
  _sim->mark_inc_mode_bad();
  tr_load_source();
...
/*--------------------------------------------------------------------------*/
inline void ADMS_BASE::ac_load_source()
{
  if (_n[OUT2].m_() != 0) {
...
/*--------------------------------------------------------------------------*/
inline void ADMS_BASE::tr_load_couple()
{
  untested();
...
/*--------------------------------------------------------------------------*/
inline void ADMS_BASE::tr_unload_couple()
{untested();
  _m0.c0 = _m0.c1 = 0.;
  _sim->mark_inc_mode_bad();
...
/*--------------------------------------------------------------------------*/
inline void ADMS_BASE::ac_load_couple()
{
  _sim->_acx.load_couple(_n[OUT1].m_(), _n[OUT2].m_(), mfactor() * _acg);
}
/*--------------------------------------------------------------------------*/
inline void ADMS_BASE::tr_load_passive()
{
...
/*--------------------------------------------------------------------------*/
inline void ADMS_BASE::tr_unload_passive()
{
  _m0.c0 = _m0.c1 = 0.;
  _sim->mark_inc_mode_bad();
...
/*--------------------------------------------------------------------------*/
inline void ADMS_BASE::ac_load_passive()
{
  _sim->_acx.load_symmetric(_n[OUT1].m_(), _n[OUT2].m_(), mfactor() * _acg);
}
/*--------------------------------------------------------------------------*/
inline void ADMS_BASE::tr_load_active()
{
  assert( _m0.c1 == _m0.c1 );
  double d = dampdiff(&_m0.c1, _m1.c1);
  if (d != 0.) {
...
/*--------------------------------------------------------------------------*/
inline void ADMS_BASE::tr_unload_active()
{untested();
  _m0.c0 = _m0.c1 = 0.;
  _sim->mark_inc_mode_bad();
...
/*--------------------------------------------------------------------------*/
inline void ADMS_BASE::ac_load_active()
{
